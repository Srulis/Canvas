...
var ldap_login_destination = "" //This is the Relative login location. Examlpe "/login/microsoft" or "/login/saml" or "/login/google"
...
var canvas_login_destination = "" //This is the Relative login location. Examlpe "/login/microsoft" or "/login/saml" or "/login/google"
...
function myJQueryCode() {
	$(document).ready(function() {
		if (document.location.pathname === "/login/canvas") {
				var canvas_loginHTML = '<center><br><br><a href="' + canvas_login_destination + '" class="btn" style="background-color:white;"> <span><img src="' + canvas_login_image + '" style="width: 20%;"></span> <span><br>' + canvas_login_text + '</span></a></center>';
				$('#login_form').after(canvas_loginHTML);
		}else if(document.location.pathname === "/login/ldap"){
			var ldap_loginHTML = '<center><br><br><a href="' + ldap_login_destination + '" class="btn" style="background-color:white;"> <span><img src="' + ldap_login_image + '" style="width: 20%;"></span> <span><br>' + ldap_login_text + '</span></a></center>';
